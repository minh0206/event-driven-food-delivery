...
class UserIntegrationTest {
    ...
    @Test
    void registerRestaurantAdmin_endToEnd_createsUserWithRestaurantId() throws Exception {
        RegisterRequestDto req = new RegisterRequestDto(
                "restaurant@test.com",
                "password123",
                "Restaurant",
        ...
        when(restaurantServiceClient.createRestaurant(any())).thenReturn(Map.of("restaurantId", 999L));
    ...
    void registerDriver_endToEnd_createsUserWithDriverId() throws Exception {
        ...
        when(deliveryServiceClient.createDriver()).thenReturn(Map.of("driverId", 888L));
